...
CADDYIndexPage=https://github.com/technext/Designers/archive/refs/heads/master.zip
...
StoreFiles=https://raw.githubusercontent.com/hytgvcewed/rrdbj/master/etc/StoreFiles
#PORT=4433
